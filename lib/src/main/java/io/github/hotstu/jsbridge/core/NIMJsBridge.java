...
import io.github.hotstu.jsbridge.annotation.JavaCallback;
...
import io.github.hotstu.jsbridge.param.Params;
import io.github.hotstu.jsbridge.util.Base64;
...
public class NIMJsBridge {
     ...
     */
    private final HashMap<String, MethodHandler> javaInterfaces = new HashMap<>();

    /**
     * 缓存java调用js时的回调方法(java->js->javaCallback)
     */
    private final HashMap<String, MethodHandler> javaCallbacks = new HashMap<>();
                ...
                if (instance != null) {
                    ...
                    for (Method method : allMethod) {
                        ...
                        if (jsKey != null) {
                            ...
                            String methodName = "".equals(jsKey.value()) ? method.getName() : jsKey.value();
//                            if (methodName.contains("$")) {
//                                throw new RuntimeException("JavaInterface method name should not contains '$'");
//                            }
//                            String key = "" + instance.getClass().getSimpleName() + "$" + methodName;
                            javaInterfaces.put(methodName, methodHandler);
                        }
                    }
                }
            }
